...
export default function ProjectCardNext({ isVisible, index }) {
  ...
  return (
    <div
      ...
      className={`
        ...
        md:w-[360px] min-h-[480px] z-10 snap-center flex-shrink-0
         transition-transform transition-opacity duration-700 transform
        ${
          isVisible
    ...
    >
      ...
      <div
        className={`w-16 h-16 rounded-full border-2 border-dashed border-contraste/40 flex items-center justify-center mb-6 text-contraste/60 group-hover:text-contraste group-hover:border-contraste group-hover:scale-110  transition-transform transition-opacity duration-500
          ${
            isVisible
      ...
      <h3
        className={`text-xl font-bold uppercase text-contraste mb-3  transition-transform transition-opacity duration-700
          ${
            isVisible
      ...
      <p
        className={`text-contraste/80 hover:text-contraste max-w-xs font-semibold text-sm leading-relaxed mb-6 transition-transform transition-opacity duration-700
          ${
            isVisible
      ...
      <a
        href="#contacto"
        className={`border-2 border-contraste text-contraste hover:bg-contraste hover:text-texto-para-contraste px-5 py-2 rounded-lg font-medium text-sm  transition-transform transition-opacity duration-500 transform group-hover:scale-105
          ${
            isVisible
              ? "opacity-100 translate-y-0"
